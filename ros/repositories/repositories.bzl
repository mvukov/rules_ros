...
def ros_repositories():
    ...
    maybe(
        http_archive,
        name = "console_bridge",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:console_bridge.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "roscpp_core",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:roscpp_core.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "rosconsole",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:rosconsole.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros_genmsg",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:genmsg.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros_gencpp",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:gencpp.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros_genpy",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:genpy.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros_std_msgs",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:std_msgs.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros_comm_msgs",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:ros_comm_msgs.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros_comm",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:ros_comm.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros_ros",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:ros.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:common_msgs.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros_actionlib",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:actionlib.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:dynamic_reconfigure.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros_geometry2",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:geometry2.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "orocos_kdl",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:orocos_kdl.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:urdfdom_headers.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "tinyxml",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:tinyxml.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "urdfdom",
        build_file = "@com_github_mvukov_rules_ros//ros/repositories:urdfdom.BUILD.bazel",
